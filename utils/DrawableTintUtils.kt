...
object DrawableTintUtils {
     ...
     */
    fun tintDrawable(drawable: Drawable, color: Int): Drawable { // 获取此drawable的共享状态实例
     ...
     * @return 可着色的drawable
     */
    private fun getCanTintDrawable(drawable: Drawable): Drawable { // 获取此drawable的共享状态实例
